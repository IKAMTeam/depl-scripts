...
rule-service ALL=(root) NOPASSWD: ${SERVICES_PATH}/*_rule-service*/python-rules-data/clean-python-workspace.sh
...
services ALL=(root) NOPASSWD: ${SERVICES_PATH}/*_services*/python-rules-data/clean-python-workspace.sh
